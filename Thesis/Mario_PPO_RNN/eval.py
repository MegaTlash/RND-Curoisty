...
def main():
    ...
    is_render = True
    model_path = 'models/Transfer/{}/Intrinsic_Transfer/{}.model'.format(env_id, env_id)
    predictor_path = 'models/Transfer/{}/Intrinsic_Transfer/{}.pred'.format(env_id, env_id)
    target_path = 'models/Transfer/{}/Intrinsic_Transfer/{}.target'.format(env_id, env_id)

...
class RNDAgent(object):
    ...
    def GetAction(self, state):
        ...
        #Get intrinsic action probability distrubiton
        #action_prob_int = F.softmax(int_policy, dim=-1).data.cpu().numpy()

        #Choosing the bigger action prob
        #action_prob = max(action_prob, action_prob_int)
